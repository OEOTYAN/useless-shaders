$input v_color0, v_texcoord0, v_lightmapUV,v_position
...
void main() {
    ...
    if((v_color0.r>v_color0.g+v_color0.b)){
        cp.x = cp.x * 3.0 - 1.1;
        cp.z = cp.z * 3.0 - 1.1;
        if (v_color0.r > 0.999 && v_color0.g > 50.0 / 255.0 - 0.005 &&
            v_color0.g < 50.0 / 255.0 + 0.005 && v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(15.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
        ...
        if (v_color0.r > 244.0 / 255.0 - 0.005 &&
            v_color0.r < 244.0 / 255.0 + 0.005 &&
            v_color0.g > 27.0 / 255.0 - 0.005 &&
            v_color0.g < 27.0 / 255.0 + 0.005 && v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(14.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.7 && cp.x >= 0.4 && cp.z <= 0.35 && cp.z >= 0.25) ||
                (cp.x <= 0.6 && cp.x >= 0.5 && cp.z <= 0.75 && cp.z >= 0.35) ||
        ...
        if (v_color0.r > 234.0 / 255.0 - 0.005 &&
            v_color0.r < 234.0 / 255.0 + 0.005 &&
            v_color0.g > 6.0 / 255.0 - 0.005 && v_color0.g < 6.0 / 255.0 + 0.005 &&
            v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(13.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.7 && cp.x >= 0.4 && cp.z <= 0.35 && cp.z >= 0.25) ||
                (cp.x <= 0.6 && cp.x >= 0.5 && cp.z <= 0.75 && cp.z >= 0.35) ||
        ...
        if (v_color0.r > 224.0 / 255.0 - 0.005 &&
            v_color0.r < 224.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(12.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.7 && cp.x >= 0.4 && cp.z <= 0.35 && cp.z >= 0.25) ||
                (cp.x <= 0.6 && cp.x >= 0.5 && cp.z <= 0.75 && cp.z >= 0.35) ||
        ...
        if (v_color0.r > 214.0 / 255.0 - 0.005 &&
            v_color0.r < 214.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(11.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.7 && cp.x >= 0.4 && cp.z <= 0.35 && cp.z >= 0.25) ||
                (cp.x <= 0.6 && cp.x >= 0.5 && cp.z <= 0.75 && cp.z >= 0.35) ||
        ...
        if (v_color0.r > 204.0 / 255.0 - 0.005 &&
            v_color0.r < 204.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(10.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.7 && cp.x >= 0.4 && cp.z <= 0.35 && cp.z >= 0.25) ||
                (cp.x <= 0.6 && cp.x >= 0.5 && cp.z <= 0.75 && cp.z >= 0.35) ||
        ...
        if (v_color0.r > 193.0 / 255.0 - 0.005 &&
            v_color0.r < 193.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(9.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
        ...
        if (v_color0.r > 183.0 / 255.0 - 0.005 &&
            v_color0.r < 183.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(8.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.3 + 0.15 && cp.x >= 0.2 + 0.15 && cp.z <= 0.55 &&
                 cp.z >= 0.45) ||
        ...
        if (v_color0.r > 173.0 / 255.0 - 0.005 &&
            v_color0.r < 173.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(7.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.2 + 0.15 && cp.x >= 0.1 + 0.15 && cp.z <= 0.75 &&
                 cp.z >= 0.25) ||
        ...
        if (v_color0.r > 163.0 / 255.0 - 0.005 &&
            v_color0.r < 163.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(6.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.3 + 0.15 && cp.x >= 0.2 + 0.15 && cp.z <= 0.55 &&
                 cp.z >= 0.45) ||
        ...
        if (v_color0.r > 153.0 / 255.0 - 0.005 &&
            v_color0.r < 153.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(5.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.3 + 0.15 && cp.x >= 0.2 + 0.15 && cp.z <= 0.55 &&
                 cp.z >= 0.45) ||
        ...
        if (v_color0.r > 142.0 / 255.0 - 0.005 &&
            v_color0.r < 142.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(4.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.2 + 0.15 && cp.x >= 0.1 + 0.15 && cp.z <= 0.75 &&
                 cp.z >= 0.25) ||
        ...
        if (v_color0.r > 132.0 / 255.0 - 0.005 &&
            v_color0.r < 132.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(3.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.2 + 0.15 && cp.x >= 0.1 + 0.15 && cp.z <= 0.75 &&
                 cp.z >= 0.25) ||
        ...
        if (v_color0.r > 122.0 / 255.0 - 0.005 &&
            v_color0.r < 122.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(2.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.3 + 0.15 && cp.x >= 0.2 + 0.15 && cp.z <= 0.55 &&
                 cp.z >= 0.45) ||
        ...
        if (v_color0.r > 112.0 / 255.0 - 0.005 &&
            v_color0.r < 112.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (mod(floor(1.0 / exp2(floor((4.0 / 0.6) * (cp.x - 0.1)))) * 1.0,
                     2.0) >= 0.5 &&
                 cp.z <= 0.15 && cp.z >= 0.1) ||
                (cp.x <= 0.4 + 0.15 && cp.x >= 0.1 + 0.15 && cp.z <= 0.35 &&
                 cp.z >= 0.25) ||
        ...
        if (v_color0.r > 76.0 / 255.0 - 0.005 &&
            v_color0.r < 76.0 / 255.0 + 0.005 && v_color0.g + v_color0.b < 0.005) {
            if ((cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.08 && cp.z >= 0.05) ||
                (cp.x <= 0.7 && cp.x >= 0.1 && cp.z <= 0.2 && cp.z >= 0.17) ||
                (cp.x <= 0.2 + 0.15 && cp.x >= 0.1 + 0.15 && cp.z <= 0.75 &&
                 cp.z >= 0.25) ||
    ...
    int ckk = 1;
    if (((chunkPos.x < linea.x + chw.x ||
          chunkPos.x > 16.0 - linea.x - chw.x) ||
         (chunkPos.z < linea.z + chw.z ||
          chunkPos.z > 16.0 - linea.z - chw.z)) &&
    ...
    for (int ci = 0; ci < ckk; ci++)
        for (int cj = 0; cj < ckk; cj++) {
            vec3 lchunkPos = fract((chunkPos + chdx * ci / float(ckk) +
                                     chdy * cj / float(ckk)) /
                                    16.0) *
                               16.0;
            vec3 lcp =
                fract(cp + chdx * ci / float(ckk) + chdy * cj / float(ckk));
