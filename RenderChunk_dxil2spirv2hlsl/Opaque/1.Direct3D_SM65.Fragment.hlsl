...
void frag_main()
{
    ...
    float4 _69 = _9.Sample(_20, float2(TEXCOORD_1.x, TEXCOORD_1.y));
    float _74 = (_60.x * COLOR.x) * _69.x;
    float _75 = (_60.y * COLOR.y) * _69.y;
    float _76 = (_60.z * COLOR.z) * _69.z;
    SV_Target.x = ((_16_m0[0u].x - _74) * COLOR_2.w) + _74;
    SV_Target.y = ((_16_m0[0u].y - _75) * COLOR_2.w) + _75;
    SV_Target.z = ((_16_m0[0u].z - _76) * COLOR_2.w) + _76;
    SV_Target.w = COLOR.w;
}
